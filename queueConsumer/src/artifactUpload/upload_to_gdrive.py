...
def authenticate_gdrive():
    ...
    parsed_key = json.loads(os.getenv('GOOGLE_KEY'))
    creds = service_account.Credentials.from_service_account_info(parsed_key, scopes=SCOPES)
...
if __name__ == "__main__":
    ...
    if os.path.exists(out_directory):
        upload_files_from_directory(out_directory,parent_id, drive_service)
    else:

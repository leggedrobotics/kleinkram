<template>
  <a class="flex items-center flex-no-wrap" style="color: grey; text-decoration: none"
    ...
    <p class="q-mb-none" style="line-height: 24px; padding-left: 6px">You can only see projects on which you have at
      least view access on project level.</p>
  </a>
</template>
<script>
export default {

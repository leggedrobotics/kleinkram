...
export class AutoRecoverMcap1789238500000 implements MigrationInterface {
    name = 'AutoRecoverMcap1789238500000';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TYPE "public"."file_event_type_enum" ADD VALUE IF NOT EXISTS 'RECOVERY_TRIGGERED'`,
        );

        // 2. Add projectUuid to action_trigger, make missionUuid nullable, and update foreign keys
        await queryRunner.query(
            `ALTER TABLE "action_trigger" ADD COLUMN IF NOT EXISTS "projectUuid" uuid`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "action_trigger" DROP CONSTRAINT IF EXISTS "FK_d351ca951638b919694a25018bd"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "action" ADD COLUMN IF NOT EXISTS "fileUuid" uuid`,
        );
        await queryRunner.query(
            `ALTER TABLE "action" ADD COLUMN IF NOT EXISTS "container_logs" json DEFAULT '[]'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "project" ADD COLUMN IF NOT EXISTS "autoRecoverMcap" boolean NOT NULL DEFAULT true`,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(
            `ALTER TABLE "project" DROP COLUMN IF EXISTS "autoRecoverMcap"`,
        );
        await queryRunner.query(
            `ALTER TABLE "action" DROP CONSTRAINT IF EXISTS "FK_b32d5c5f495f0825273afa03e69"`,
        );
        await queryRunner.query(
            `ALTER TABLE "action" DROP COLUMN IF EXISTS "fileUuid"`,
        );
        await queryRunner.query(
            `ALTER TABLE "action" DROP COLUMN IF EXISTS "container_logs"`,
        );
        await queryRunner.query(
            `ALTER TABLE "action_trigger" DROP CONSTRAINT IF EXISTS "FK_d351ca951638b919694a25018bd"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "action_trigger" DROP COLUMN IF EXISTS "projectUuid"`,
        );
        await queryRunner.query(

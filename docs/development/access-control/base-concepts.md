...
These default groups can be configured in the configuration file: `access_config.json` (project root). The path can be overridden with the `ACCESS_CONFIG_PATH` environment variable.
